...
export default function Footer() {
  return (
    <div className="shadow-lg p-16 mb-5 bg-body rounded bg-purple-300">
      <footer className="footer text-base-content p-10 shadow-lg p-3 mb-5 bg-body rounded">
        ...
        <form className="text-white font-semibold  ">
